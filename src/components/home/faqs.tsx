        ...
        <div className="relative">
          <div className="bg-[#140D27] py-16 flex flex-col lg:flex-row text-white items-center gap-x-24">
            <div className="space-y-4 text-center lg:text-left mt-6">
              ...
              <p className="font-body leading-7 lg:w-4/5 text-[12px] sm:text-base">
            ...
            <img
              className="sm:w-[541px] sm:h-[605px] 2xl:w-auto 2xl:h-auto"
              src="./images/faq-img.png"
              alt=""
            />
          </div>
          <img
            className="absolute h-[13px] w-[11px] lg:h-auto lg:w-auto -left-10 top-32 animate-pulse"
